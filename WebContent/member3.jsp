    ...
    <div id="azen-produc">
        <div class="azen-tittop clearfix">
            <div class="azen-titles fl clearfix">
                <h3>违规用户查询 <img src="themes/img/icon/sc.png" width="17" height="23" title="" alt=""></h3>
                <p class="azen-titlep clearfix"><span class="fl">查询违规用户信息</span><i class="fa fa-edit"></i> </p>
                ...
                <div class="azen-fiform">
                    <fieldset>
                        <form action="${pageContext.request.contextPath }/userregister.action" method="post" onsubmit="return check()">
                            ${msg}
                            <p class="clearfix">
                                <label class="fl"><em> * </em>违规用户ID:</label>
                          ...
                          <!--   <p class="clearfix">
                           ...
                           <!--  <p class="clearfix">
                            ...
                            <p class="clearfix">
                                <button id="zhuce">查找</button>&nbsp;&nbsp;&nbsp;<span id="message">${msg}</span>
                            </p>
                        </form>
                    </fieldset>
                </div>
    ...
    $(document).ready(function(){
    	...
    	$("#rusername").blur(
    			function(){
    				$(".rname_lable").empty();
    				if(this.value==""){
    					$("#rusername").after("<label class='rname_lable'><font>查询ID不能为空</font></label>");
    				}else if(this.value.length<6){
    					$("#rusername").after("<label class='rname_lable'><font>查询ID不能小于6位</font></label>");
    				}
    			}		
    	)
    	$("#rpassword").blur(
