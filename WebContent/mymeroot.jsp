    ...
    <div class="azen-backgr azen-cleras">
           ...
           <div class="azen-workss">
            ...
            <div class="azen-production">
                ...
                <%if(video.size()!=0){ 
                    ...
                    <li>
                    <a  href="${pageContext.request.contextPath }/deletevideo.action?videoid=<%=video1.getVideoid() %>&id=2" style="display: block;margin-top:30px;margin-left:15px;background-image: url('themes/img/icon/删除.png');height: 105px;width: 195px"></a>
                    </li>
                <%	}
                }
                %>
        ...
        <div class="azen-boxche">
            ...
            <div class="azen-production">
                <ul class="azen-lister clearfix">
                   <%--  <li>
                        <div><a about="" title="" target="_blank" href="<%= fvideo.get(0).getVideourl()%>"><img width="230" height="188" alt="" title="" src="<%= fvideo.get(0).getImgurl()%>"></a></div>
                        <div>
                            <ul class="azen-viewit list-viewit">
                                <li class="viewit"><a href="#"><%= fvideo.get(0).getType()%></a> </li>
                                <li class="likeit"><a href="#"><%= fvideo.get(0).getPageview()%></a> </li>
                                <li class="luatio"><a href="#">暂无评论</a> </li>
                            </ul>
                            <div class="azen-paddin"><a target="_blank" href="<%= fvideo.get(0).getVideourl()%>"><%= fvideo.get(0).getVideoname()%></a>  </div>
                        </div>
                    </li>
                    <li>
                        <div><a about="" title="" target="_blank" href="<%= fvideo.get(1).getVideourl()%>"><img width="230" height="188" alt="" title="" src="<%= fvideo.get(1).getImgurl()%>"></a></div>
                        <div>
                            <ul class="azen-viewit list-viewit">
                                <li class="viewit"><a href="#"><%= fvideo.get(1).getType()%></a> </li>
                                <li class="likeit"><a href="#"><%= fvideo.get(1).getPageview()%></a> </li>
                                <li class="luatio"><a href="#">暂无评论</a> </li>
                            </ul>
                            <div class="azen-paddin"><a target="_blank" href="<%= fvideo.get(1).getVideourl()%>"><%= fvideo.get(1).getVideoname()%></a>  </div>
                        </div>
                    </li>
                    <li>
                        <div><a about="" title="" target="_blank" href="<%= fvideo.get(2).getVideourl()%>"><img width="230" height="188" alt="" title="" src="<%= fvideo.get(2).getImgurl()%>"></a></div>
                        <div>
                            <ul class="azen-viewit list-viewit">
                                <li class="viewit"><a href="#"><%= fvideo.get(2).getType()%></a> </li>
                                <li class="likeit"><a href="#"><%= fvideo.get(2).getPageview()%></a> </li>
                                <li class="luatio"><a href="#">暂无评论</a> </li>
                            </ul>
                            <div class="azen-paddin"><a target="_blank" href="<%= fvideo.get(2).getVideourl()%>"><%= fvideo.get(2).getVideoname()%></a> </div>
                        </div>
                    </li>
                    <li>
                        <div><a about="" title="" target="_blank" href="<%= fvideo.get(3).getVideourl()%>"><img width="230" height="188" alt="" title="" src="<%= fvideo.get(3).getImgurl()%>"></a></div>
                        <div>
                            <ul class="azen-viewit list-viewit">
                                <li class="viewit"><a href="#"><%= fvideo.get(3).getType()%></a> </li>
                                <li class="likeit"><a href="#"><%= fvideo.get(3).getPageview()%></a> </li>
                                <li class="luatio"><a href="#">暂无评论</a> </li>
                            </ul>
                            <div class="azen-paddin"><a target="_blank" href="<%= fvideo.get(3).getVideourl()%>"><%= fvideo.get(3).getVideoname()%></a> </div>
                        </div>
                    </li> --%>
                </ul>
