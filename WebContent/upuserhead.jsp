...
String userimgurl=(String)request.getAttribute("userimgurl");
        ...
        <div id="azen-logino">
         <ul class="login fr">
        	...
        	<div class="azen-userimg">
                <ul>
                    <li>
                        <div class="menu" id="navbox"> <a href="${pageContext.request.contextPath }/listgerenzhongxin.action?username=<%=username %>" class="tit"><img src="<%=userimgurl %>" width="26px" height="26px"/></a>
                            <div class="subnav">
    ...
    <div id="azen-produc">
        <div class="azen-tittop clearfix">
            <div class="azen-titles fl clearfix">
                <h3>修改头像 <img src="themes/img/icon/sc.png" width="17" height="23" title="" alt=""></h3>
                <p class="azen-titlep clearfix"><span class="fl">修改头像</span><i class="fa fa-edit"></i> </p>
        ...
        <div class="azen-backgr">
            <div class="azen-texter azne-workss">
                ...
                <div class="azen-fiform">
                    <fieldset>
                        <form action="${pageContext.request.contextPath }/updateuserhead.action" method="post" enctype="multipart/form-data">
                            <p class="clearfix">
                                <label class="fl"><em> * </em></label>
                                <input id="azen-username" class="azen-username" value="<%=username %>" type="hidden" name="username">
                            </p>
                            <p class="clearfix">
                                <label class="fl"><em> * </em>原头像:</label>
                            </p>
                           		<img alt="" src="<%=userimgurl %>" width="200px" height="200px">
                            <p class="clearfix">
