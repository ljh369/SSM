...
List<Video> hotvideo=(List)request.getAttribute("hotvideo");
...
<header id="azen-header">
    <div class="azen-conter">
        <div class="azen-logoer fl">
            <h1><a href="./" title="滴答滴答">滴答滴答</a></h1>
        </div>
...
<div style="position: fixed;width:250px;height:350px;position: fixed;border-style:groove;border-color:#90F;
	background-color: #FFF;margin:0;padding:0;list-style:none;float: right;">
		<ul>
			<li style="text-align: center;font-size: xx-large;">今日热门</li>
			<li style="text-align: center;"><a href="${pageContext.request.contextPath }/videofind.action?videoid=<%= hotvideo.get(0).getVideoid()%>&id=2&pageview=<%= hotvideo.get(0).getPageview() %>"><img alt="" src="<%=hotvideo.get(0).getImgurl() %>" style="height: 115px" height="250px"></a></li>
			<li style="text-align: center;"><%=hotvideo.get(0).getVideoname() %></li>
			<li style="text-align: center;"><%=hotvideo.get(0).getPageview() %>浏览量</li>
			<li style="text-align: center;"><a href="${pageContext.request.contextPath }/videofind.action?videoid=<%= hotvideo.get(1).getVideoid()%>&id=2&pageview=<%= hotvideo.get(1).getPageview() %>"><img alt="" src="<%=hotvideo.get(1).getImgurl() %>" style="height: 115px" height="250px"></a></li>
			<li style="text-align: center;"><%=hotvideo.get(1).getVideoname() %><%=hotvideo.get(1).getPageview() %>浏览量</li>
			<li style="text-align: center;"><%=hotvideo.get(1).getVideoname() %></li>
		</ul>
</div>
<section>
    <div id="azen-produc">
                	 ...
                	 <li>
                        ...
                        <div>
                            <ul class="azen-viewit list-viewit">
                                ...
                                <li class="viewit"><a href="#"><%= video1.getPageview() %></a> </li>
...
<div style="width:1003px; margin:0 auto; height:70px; padding-left:20px;" ><a href=""><img border="0" style="height:40px;" src=""/></a>
</div>
...
<footer id="azen-footer">
    <div class="azen-footer">
        ...
        <!-- <p>Copyright (c) 2015 <a href="http://dida.com" style="color:#f60; text-decoration:underline;">http://www.azenui.com</a> . All Rights Reserved  京ICP备15006025号-1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;建议使用Chrome、Firefox、Safari、ie10版本浏览器。</p> -->
    </div>
</footer>
        ...
        <div class="loginwrap">
            ...
            <form action="${pageContext.request.contextPath }/userlogin.action" method="post" id="login_form" onsubmit="return check()">
                <div class="logininput">
                  ...
                  <!--   <input id="message" type="hidden" name="message" value="${msg} " class="loginuserpasswordt"  placeholder="验证" />-->
                </div>
                <div class="loginbtn">
...
if(msg=="error"){
	...
	alert("注册成功请登录");
}else if(msg=="registerokerror"){
	alert("注册失败");
}else if(msg=="您输入的不是管理员账号"){
	alert("您输入的不是管理员账号");
}
function check(){
